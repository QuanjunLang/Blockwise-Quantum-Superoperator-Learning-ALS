...
addOptional(p, 'ALS_Acceleration', 'Nesterov');
...
[X_est_first_row, ALS_outputInfo] = ALS_shared_U(A, new_b, r, 'Acceleration', ALS_Acceleration, 'debugON', ALS_debugON, 'X_true', X_true(1:N, :), ...
