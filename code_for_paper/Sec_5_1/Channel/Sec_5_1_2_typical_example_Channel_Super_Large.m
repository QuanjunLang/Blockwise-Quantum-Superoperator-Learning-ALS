...
for i = 1:Num_samples
    ...
    %% First Row Joint
    [all_K_est{2, i}, all_Info{2, i}] = Learning_quantum_operator(A, b, r, 'Method', 'First_row', 'X_true_sub_blocks', RK_sub_blocks, 'X_true', RK, 'num_retry', 0, 'debugON', 0, 'displayON', 1, 'compute_dnorm', dnorm_flag, ...
        'ALS_debugON', 0, 'ALS_Acceleration', 'Nesterov', 'ALS_loss_tol', 1e-8, 'ALS_rel_err_tol', 1e-8);

    %% First Row subset
    [all_K_est{3, i}, all_Info{3, i}] = Learning_quantum_operator(A, b, r, 'Method', 'First_row_subset', 'X_true_sub_blocks', RK_sub_blocks, 'X_true', RK, 'num_retry', 0, 'debugON', 0, 'displayON', 1, 'compute_dnorm', dnorm_flag, ...
...
% Write to CSV
writetable(T, '5_1_2_Lindbladian_typical_data_Super_Large.csv')
writetable(T, '/Users/quanjunlang/Documents/GitHub/Learning-operators-in-Lindblad-Master-Equation-Paper/5_1_2_Lindbladian_typical_data_Super_Large.csv')
