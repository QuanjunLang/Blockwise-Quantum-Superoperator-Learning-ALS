...
sysInfo.n               = 16;           %
sysInfo.M               = 120;          % number of independent trajectories
...
for i = 1:Num_samples
    ...
    % [RK_est_temp, RK_Info_temp] = ALS(A_mat, b_mat, r, 'X_true', RK, 'debugON', 1, 'Acceleration', 'Polyak', 'beta', 0.5, 'rel_err_tol', 1e-5);
    % 
    ...
    [all_K_est{1, i}, RK_Info_temp] = ALS(A_mat_TRO, b_mat_TRO, r, 'X_true', RK, 'Acceleration', 'Nesterov',...
        'beta', 0.3, 'loss_tol', 1e-8, 'rel_err_tol', 1e-4, 'debugON', 1, 'maxIter', 500);
...
save('5_1_2_Lindbladian_typical_data_Large.mat', "all_form")
...
% 
% % Write to CSV
% writetable(T, '5_1_2_Lindbladian_typical_data_Large.csv')
% writetable(T, '/Users/quanjunlang/Documents/GitHub/Learning-operators-in-Lindblad-Master-Equation-Paper/5_1_2_Lindbladian_typical_data_Large.csv')
