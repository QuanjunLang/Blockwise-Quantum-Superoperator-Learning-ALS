...
%%
temp = load('5_1_2_Lindbladian_typical_data.mat', 'all_form');
...
%%
temp = load('5_1_2_Lindbladian_typical_data_Large.mat', 'all_form');
all_form = temp.all_form;
...
%%
temp = load('5_1_2_Lindbladian_typical_data_Ex_Large.mat', 'all_form');
all_form = temp.all_form;
...
writetable([T1;T2;T3], '5_1_2_Lindbladian.csv')
