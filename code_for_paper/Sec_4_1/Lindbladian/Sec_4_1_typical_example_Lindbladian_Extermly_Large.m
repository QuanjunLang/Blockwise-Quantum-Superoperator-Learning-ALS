...
for i = 1:Num_samples
    ...
    [all_K_est{1, i}, all_Info{1, i}] = Learning_quantum_operator(A, b, r, 'Method', 'First_row', 'X_true_sub_blocks', RK_sub_blocks, 'X_true', RK, 'num_retry', 0, 'debugON', 0, 'displayON', 1, 'compute_dnorm', dnorm_flag, ...
        'ALS_debugON', 1, 'ALS_Acceleration', 'Polyak', 'ALS_beta', 0.6, 'ALS_loss_tol', 1e-8, 'ALS_rel_err_tol', 1e-5);
    ...
    [all_K_est{2, i}, all_Info{2, i}] = Learning_quantum_operator(A, b, r, 'Method', 'First_row_subset', 'X_true_sub_blocks', RK_sub_blocks, 'X_true', RK, 'num_retry', 0, 'debugON', 0, 'displayON', 1, 'compute_dnorm', dnorm_flag, ...
        'ALS_debugON', 1, 'ALS_Acceleration', 'Polyak', 'ALS_beta', 0.6, 'ALS_loss_tol', 1e-8, 'ALS_rel_err_tol', 1e-5, 'sub_ind_ratio', 0.1);
...
save('4_1_Lindbladian_typical_data_Ex_Large.mat')
save('4_1_Lindbladian_typical_data_Ex_Large_all_form.mat', 'all_form');
%%
...
% 
% % Write to CSV
% writetable(T, '5_1_2_Lindbladian_typical_data_Extrem_Large.csv')
% writetable(T, '/Users/quanjunlang/Documents/GitHub/Learning-operators-in-Lindblad-Master-Equation-Paper/5_1_2_Lindbladian_typical_data_Extrem_Large.csv')
