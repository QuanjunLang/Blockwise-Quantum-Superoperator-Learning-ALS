...
%%
temp = load('4_1_Channel_typical_data.mat', 'all_form');
...
%%
temp = load('4_1_Channel_typical_data_Large.mat', 'all_form');
all_form = temp.all_form;
...
temp = load('4_1_Channel_typical_data_Ex_Large_all_form.mat', 'all_form');
all_form = temp.all_form;
