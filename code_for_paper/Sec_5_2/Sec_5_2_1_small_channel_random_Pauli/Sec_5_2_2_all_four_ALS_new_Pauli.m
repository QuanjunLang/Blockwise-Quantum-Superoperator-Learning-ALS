...
for i = 1:Num_M
    for k = 1:Num_samples
        ...
        [A_mat_TRO, b_mat_TRO] = get_A_b_TRO_Pauli(sysInfo, RK);
...
tightfig(gcf)
saveas(gcf, 'Sec_5_2_small_test_rate_channel_Pauli.pdf')
...
set(findall(gcf,'-property','FontSize'),'FontSize',ftsz);
tightfig(gcf)
saveas(gcf, 'Sec_5_2_small_test_time_channel_Pauli.pdf')

%%

save('Channel_Random_Pauli.mat')
