...
def test():
    ...
    rho_outputs = [vector_to_operator(L * operator_to_vector(rho_0)) for rho_0 in rho_initial]
    ...
    return result, L.full(), RL.full(), [rho_0.full() for rho_0 in rho_initial], elapsed_time, [o.full() for o in O], np.array([rho1.full() for rho1 in rho_outputs]), [k.full() for k in K]
